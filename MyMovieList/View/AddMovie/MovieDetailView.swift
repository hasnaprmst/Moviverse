...
//                        if let date = movie.release_date {
//                            Text("\(movie.title) (\(date.prefix(4)))") // Combines title and year in the format "Title (Year)"
//                                .font(.title3)
//                                .bold()
//                                 // Restrict to a single line
//                               
//                                .foregroundColor(.primary)
//                                .padding(.leading, 130) // Adjust padding to position the text
//                        } else {
//                            Text(movie.title) // Display only the title if there's no release date
//                                .font(.title3)
//                                .bold()
//                                .foregroundColor(.primary)
//                                .padding(.leading, 130) // Adjust padding for title
//                        }
//                    }
                    //Durasi
                ...
                Button(action: {
                    ...
                    Text("ADD TO PLAYLIST")
                        .font(.subheadline)
                        .fontWeight(.semibold)// Menyesuaikan ukuran font
                        .foregroundColor(Color("secondColor"))
                        .frame(maxWidth: .infinity, minHeight: 50) // Lebar tombol penuh dan tinggi minimum
                        .background(Color("mainColor"))
                        .cornerRadius(10) // Sudut tombol membulat
                }
        ...
        .sheet(isPresented: $showingAddSheet) {
            AddToPlaylistView(tmdbMovie: movie)
        }
